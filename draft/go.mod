module github.com/go-masonry/scaffolds/draft
...
require (
	...
	github.com/go-masonry/bdatadog v0.0.0-00010101000000-000000000000
	...
	github.com/go-masonry/mortar v0.0.0-20200730140042-3e1a088a6de3
